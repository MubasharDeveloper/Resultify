...
import { getFirestore, collection, query, where, getDocs, orderBy, updateDoc, setDoc, deleteDoc, doc, addDoc } from "firebase/firestore";
...
export { analytics, auth, db, collection, query, where, getDocs, updateDoc, setDoc, orderBy, deleteDoc, doc, addDoc };